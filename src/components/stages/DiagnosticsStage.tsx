  ...
  return (
    <section className="animate-fade-in space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_1fr]">
        <div className="space-y-5 rounded-xl border border-ink/10 bg-white/55 p-5 shadow-sm">
          {(
            [
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-ink/10 bg-white/55 p-5 shadow-sm">
          ...
          <div className="rounded-xl border border-ink/10 bg-white/55 p-5 shadow-sm">
            <h3 className="font-medium text-ink">Weaknesses</h3>
            <ul className="mt-2 list-disc space-y-1 pl-4 text-sm text-ink/70">
          ...
          <div className="rounded-xl border border-ink/10 bg-white/55 p-5 shadow-sm">
            <h3 className="font-medium text-ink">Guardrail findings</h3>
            <ul className="mt-3 space-y-3">
              {result.guardrails.map((g) => (
                <li key={g.finding} className="text-sm">
                  ...
                  <p className="text-ink/75">{g.finding}</p>
                </li>
              ))}
            </ul>
          </div>
